...
export default function FromOneStoreSection({ control, sectionKey, errors }) {
                    ...
                    <Grid size={{ xs: 12 }}>
                        ...
                        <Box display="flex" justifyContent="space-between" alignItems="center" mb={2}>
                            <Typography variant="h6" fontWeight={600}>
                                Tabs ({highlightFields.length}/2)
                            </Typography>
                            <Button type="button" variant="outlined" size="small" startIcon={<Add />} onClick={() => addHighlight()} disabled={!canAddMore}>
                                Add Tab
                            </Button>
                        </Box>
                    </Grid>
