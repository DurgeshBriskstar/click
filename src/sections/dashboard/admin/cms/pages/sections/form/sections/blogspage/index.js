...
export default function BlogListPageSections({ control, errors }) {
    return (
        <>
            ...
            <Grid container spacing={3}>
                <Grid size={{ xs: 12 }}>
                    <Typography fontWeight={400}><b>Note: </b>All the blogs displayed in this page will be sourced from the Blogs module.</Typography>
                </Grid>
            </Grid>
        </>
    );
