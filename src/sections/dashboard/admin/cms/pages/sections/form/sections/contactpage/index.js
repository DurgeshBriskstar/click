...
export default function ContactPageSections({ control, errors }) {
    return (
        <>
            ...
            <Grid container spacing={3}>
                <Grid size={{ xs: 12 }}>
                    <Typography fontWeight={400}><b>Note: </b>This page reflects the contact form and contact informations automatically from the store module based on the store selection.</Typography>
                </Grid>
            </Grid>
        </>
    );
