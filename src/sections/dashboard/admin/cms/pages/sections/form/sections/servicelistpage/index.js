...
export default function ServiceListPageSections({ control, errors }) {
    return (
        <>
            ...
            <Grid container spacing={3}>
                <Grid size={{ xs: 12 }}>
                    <Typography fontWeight={400}><b>Note: </b>All the services displayed in this page will be sourced from the Services module.</Typography>
                </Grid>
            </Grid>
        </>
    );
