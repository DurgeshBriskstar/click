...
import StatSection from "./sections/5_StatSection";
...
const sectionConfigs = [
    ...
    { section_key: "stat_section", label: "Statistics Section" },
...
export default function LayoutOne({ control, errors }) {
    return (
        <Box>
                    ...
                    <AccordionDetails>
                        {(() => {
                            switch (config.section_key) {
                                ...
                                case "stat_section":
                                    return <StatSection control={control} index={index} sectionKey={config.section_key} errors={errors} />;
