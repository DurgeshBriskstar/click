...
import DetailSection3 from "./sections/4_DetailSection3";
import DetailSection4 from "./sections/5_DetailSection4";
...
const sectionConfigs = [
    ...
    { section_key: "detail_section3", label: "Detail Section 3" },
    { section_key: "detail_section4", label: "Detail Section 4" },
...
export default function LayoutTwo({ control, errors }) {
    return (
        <Box>
                    ...
                    <AccordionDetails>
                        {(() => {
                            switch (config.section_key) {
                                ...
                                case "detail_section3":
                                    return <DetailSection3 control={control} index={index} sectionKey={config.section_key} errors={errors} />;
                                case "detail_section4":
                                    return <DetailSection4 control={control} index={index} sectionKey={config.section_key} errors={errors} />;
