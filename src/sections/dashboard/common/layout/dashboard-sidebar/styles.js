...
const SidebarWrapper = styled("div", { shouldForwardProp: prop => prop !== "compact" })(({ theme, compact }) => ({
  width: 280,
  height: "100vh",
  position: "fixed",
...
const NavItemButton = styled(ButtonBase, {
  ...
  ...(active && {
    color: themeColors?.lWhite,
    backgroundColor: alpha(themeColors?.lDark, 0.6),
