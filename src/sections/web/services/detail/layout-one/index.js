...
export default function ServiceLayoutOne({ serviceData, sections, services, partners, faqs }) {
  ...
  return (
    <div className="service-detail-page layout-one">
      ...
      {sections?.stat_section && (<StatSection data={sections.stat_section} />)}
