...
export default function DetailSection4({ data, store }) {
      ...
      <Container>
        <Row className="align-items-center">
          <Col xs={12} md={12} lg={6} data-aos="fade-right">
            ...
            {data?.subtitle && (<p className="m-0 mb-4" data-aos="fade-up" data-aos-delay="200">{data.subtitle}</p>)}
          ...
          <Col xs={12} md={12} lg={6} data-aos="fade-up">
            <div className="store-contact-card">
                ...
                <div className="store-contact-card-image-wrapper">
                  <div className="store-contact-card-image">
                    {data.background_image?.startsWith("/backend-assets") ? (
                      ...
                      <Image src={data.background_image} alt={data?.title || "Service Detail"} fill className="object-fit-cover" />
                    )}
                  </div>
                </div>
              )}
              <div className="store-contact-card-overlay">
                <div className="store-contact-card-content">
                  ...
                  <Image src="/images/sections/stores/down-arrow.png" alt="down-arrow" width={100} height={100} className="down-arrow-icon" />
